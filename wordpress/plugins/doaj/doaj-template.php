...
<?php while ( have_posts() ): the_post(); ?>
  <record>
    ...
    <?php if (FALSE): ?><startPage>...</startPage><!--n/a for us-->
    <endPage>...</endPage><!--n/a for us--><?php endif; ?>
    ...
    <title language="<?php bloginfo('language'); ?>"><?php the_title(); ?></title>
    ...
    <abstract language="<?php bloginfo('language'); ?>"><?php the_excerpt(); ?></abstract>

    <fullTextUrl format="html"><?php the_permalink(); ?></fullTextUrl>
    <?php $tags = get_the_tags();
    if ( !empty( $tags ) ): ?>
      <keywords language="<?php bloginfo('language'); ?>">
